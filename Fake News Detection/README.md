...
In this project, I used basic machine learning with the Naive Bayes algorithm and NLP. Anyway, there is something interesting if you follow these steps :D
